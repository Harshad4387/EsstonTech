...
const {  createOrder,
  getcreatedorders,
  getApprovedOrders,deleteOrder,editOrder,approveOrder,generateQuotationPdf} = require("../../controllers/Account/Order.controller")
...
router.post("/get-pdf", generateQuotationPdf);
